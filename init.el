...
(setq cdlatex-math-modify-prefix [(meta ?m)]
	...
	("pda" nil "$M?=(Q,\\Sigma,\\Gamma,\\delta,q_0,z,F)$" cdlatex-position-cursor nil t t)
	("cfg" nil "$G=(V,T,S,P)$" cdlatex-position-cursor nil t t)
	("tm" nil "$M=(Q,\\Sigma,\\Gamma,\\delta,q_0,\\square,F)$" cdlatex-position-cursor nil t t)
	("wig" nil "$w\\in L(G)$" cdlatex-position-cursor nil t t)
	("anbn" nil "$L=\\set{a^nb^n}{n\\ge0}$" cdlatex-position-cursor nil t t)
	("L" nil "$L=\\set{?}{}$" cdlatex-position-cursor nil t t)
	("lg" nil "$L(G)$" cdlatex-position-cursor nil t t)
	("lgh" nil "$L(\\widehat G)$" cdlatex-position-cursor nil t t)
...
(defun pda-replace (beginning end)
  (interactive "*r")
  ...
  (save-match-data
    (save-excursion
      ...
      (goto-char beginning)
      (while (search-forward "□" end t)
        (replace-match "\\\\square " nil nil nil))
      (goto-char beginning)
      (while (search-forward "δ" end t)
        (replace-match "\\\\delta " nil nil nil))
      (goto-char beginning)
      ...
      (goto-char beginning)
      (while (re-search-forward "⊢" end t)
        (replace-match "\\\\vdash " nil nil nil))
      (goto-char beginning)
      (while (re-search-forward "q" end t)
        (replace-match "q_" nil nil nil))
      (goto-char beginning)
      (while (re-search-forward "∈" end t)
        (replace-match "\\\\in " nil nil nil))
      (set-marker end nil))))
...
(defun cfg-replace (beginning end)
  ...
  (save-match-data
    (save-excursion
      ...
      (goto-char beginning)
      (while (re-search-forward "·" end t)
        (replace-match "\\\\cdot " nil nil nil))
      (goto-char beginning)
      (while (re-search-forward "⇒" end t)
