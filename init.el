...
(custom-set-faces
 ...
 '(magit-diff-added-highlight ((t (:foreground "#d7af87" :background "#00af00"))))
 '(magit-diff-base ((t (:background "#5f5f00"))))
 '(magit-diff-base-highlight ((t (:background "#878700"))))
 '(magit-diff-context-highlight ((t (:foreground "#d7af87" :background "#303030"))))
 '(magit-diff-removed ((t (:background "#5f0000"))))
 '(magit-diff-removed-highlight ((t (:foreground "#d7af87" :background "#af0000"))))
